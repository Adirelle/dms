...
func (me *Server) serviceControlHandler(w http.ResponseWriter, r *http.Request) {
	...
	bodyStr := fmt.Sprintf(`<?xml version="1.0" encoding="utf-8" standalone="yes"?><s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/" s:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"><s:Body>%s`, soapRespXML)
	w.WriteHeader(code)
